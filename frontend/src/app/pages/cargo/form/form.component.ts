...
export class FormComponent implements OnInit {
  ...
  constructor(
    ...
    this.route.params.subscribe(params=>{
      if(params['id']){
        ...
        this.http.get('/component/cargo/update/'+params['id']+'/').subscribe(data =>{
          this.data = data.json() as [any]

          console.log(this.data)

          this.form.setValue({
            id_carg: this.data[0].id_cargo,
            nom_carg: this.data[0].nombre_cargo
          })
        })
      }
    }
  ...
  onSubmit(form){
    ...
    const Endpoint= 'component/cargo/reg/'
